...
the best model using two variables is the model using height and width.

## Pike
Find the best 2 predictors for the weight of a Pike
...
the best model is all the variables
### Best Two regressor model
the best model using two variables is the model using length1 and length3.
## Roach

Find the best 2 predictors for the weight of a Roach
```{r}
...
### Best Two regressor model
the best model using two variables is the model width and length3


## Final Summary Statements

The best models for Perch,the best model is all the variables and also the two best regressor model is the best model using two variables is the model using height and width ,For pike the best models are length1 and length3, Roach is width and length3.
